package
{
	...
	public class C_01 extends FlxState
	{
		//Embed the cutscene swf relative to the root of the Flixel project here
		[Embed(source = 'C_01.swf')] private var SwfClass:Class;	 
		...
		//	If the app is in full screen mode execute this code
			isFullScreen = true;
